...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <hr />
    <asp:GridView EmptyDataText="Não foram encontrados registos" CssClass="table" ID="GridView1" runat="server" DataSourceID="SqlNotas" AutoGenerateColumns="False" DataKeyNames="id">
        <Columns>
            <asp:TemplateField ShowHeader="False">
                <EditItemTemplate>
                    <asp:LinkButton CssClass="btn btn-danger" runat="server" Text="Update" CommandName="Update" CausesValidation="True" ID="LinkButton1"></asp:LinkButton>&nbsp;
                    <asp:LinkButton CssClass="btn btn-info" runat="server" Text="Cancel" CommandName="Cancel" CausesValidation="False" ID="LinkButton2"></asp:LinkButton>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:LinkButton CssClass="btn btn-info" runat="server" Text="Edit" CommandName="Edit" CausesValidation="False" ID="LinkButton1"></asp:LinkButton>&nbsp;
                    <asp:LinkButton CssClass="btn btn-danger" OnClientClick="return confirm('Tem a certeza que pretende eliminar esta nota?');" runat="server" Text="Delete" CommandName="Delete" CausesValidation="False" ID="LinkButton2"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="id_disciplina" SortExpression="id_disciplina">
                ...
                <ItemTemplate>
                    <asp:Label CssClass="form-control" runat="server" Text='<%# Bind("id_disciplina") %>' ID="Label1"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="nprocesso" SortExpression="nprocesso">
                ...
                <ItemTemplate>
                    <asp:Label CssClass="form-control" runat="server" Text='<%# Bind("nprocesso") %>' ID="Label2"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="valor" SortExpression="valor">
                <EditItemTemplate>
                    <asp:TextBox CssClass="form-control" TextMode="Number" runat="server" Text='<%# Bind("valor") %>' ID="valorTextBox"></asp:TextBox>
                ...
                <ItemTemplate>
                    <asp:Label CssClass="form-control" runat="server" Text='<%# Bind("valor") %>' ID="Label3"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="data" SortExpression="data">
                <EditItemTemplate>
                    <asp:TextBox CssClass="form-control" TextMode="Date" runat="server" Text='<%# Bind("data","{0:yyyy-MM-dd}") %>' ID="dataTextBox"></asp:TextBox>
                ...
                <ItemTemplate>
                    <asp:Label CssClass="form-control" runat="server" Text='<%# Bind("data","{0:dd-MM-yyyy}") %>' ID="Label4"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="nrmodulo" SortExpression="nrmodulo">
                <EditItemTemplate>
                    <asp:TextBox CssClass="form-control" TextMode="Number" runat="server" Text='<%# Bind("nrmodulo") %>' ID="nrmoduloTextBox"></asp:TextBox>
                ...
                <ItemTemplate>
                    <asp:Label CssClass="form-control" runat="server" Text='<%# Bind("nrmodulo") %>' ID="Label5"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
